...
% mass in Earth Unit (5,9726Ã—10e24 kg)
...
% density in Earth Unit (5,51 g/cmÂ³)
...
%k2_18_b (mesoplanet)
esempio(habitable, [radius = small, mass_class = neptunian, density = medium, gravity = high, eq_temp = acceptable, composition = rocky_iron, atmosphere = hydrogene_rich, eccentricity = elliptic, orbit_period_days = a_lot, zone_class = warm, num_stars = 1, metallicity = medium, star_temp_class = m]).

%k2_10_b
esempio(non_habitable, [radius = medium, mass_class = neptunian, density = low, gravity = medium, eq_temp = too_high, composition = water_gas, atmosphere = metals_rich, eccentricity = elliptic, orbit_period_days = many, zone_class = hot, num_stars = 1, metallicity = low, star_temp_class = g]).

%trappist_1f (psyc)
esempio(habitable, [radius = small, mass_class = terran, density = low, gravity = weak, eq_temp = acceptable, composition = rocky_water, atmosphere = metals_rich, eccentricity = parabolic, orbit_period_days = few, zone_class = warm, num_stars = 1, metallicity = medium, star_temp_class = m]).

%trappist_1b
esempio(non_habitable, [radius = small, mass_class = terran, density = medium, gravity = weak, eq_temp = too_high, composition = rocky_water, atmosphere = metals_rich, eccentricity = circular, orbit_period_days = few, zone_class = hot, num_stars = 1, metallicity = medium, star_temp_class = m]).

%k2_139_b
esempio(non_habitable,[radius = medium, mass_class = jovian, density = low, gravity = weak, eq_temp = too_high, composition = gas, atmosphere = hydrogene_rich, eccentricity = elliptic, orbit_period_days = a_lot, zone_class = hot, num_stars = 1, metallicity = medium, star_temp_class = g]).

%k2_110_b
esempio(non_habitable,[radius = small, mass_class = neptunian, density = medium, gravity = medium, eq_temp = too_high, composition = rocky_water, atmosphere = metals_rich, eccentricity = circular, orbit_period_days = many, zone_class = hot, num_stars = 1, metallicity = low, star_temp_class = k]).

%wasp_118_b
esempio(non_habitable,[radius = large, mass_class = jovian, density = medium, gravity = weak, eq_temp = too_much_high, composition = gas, atmosphere = metals_rich, eccentricity = circular, orbit_period_days = few, zone_class = hot, num_stars = 1, metallicity = medium, star_temp_class = f]).

%ross_128_b (meso)
esempio(habitable, [radius = small, mass_class = terran, density = medium, gravity = weak, eq_temp = acceptable, composition = rocky_iron, atmosphere = metals_rich, eccentricity = parabolic, orbit_period_days = many, zone_class = warm, num_stars = 1, metallicity = low, star_temp_class = m]).

%gj180b (meso)
esempio(habitable, [radius = small,  mass_class = superterran, density = medium, gravity = medium, eq_temp = acceptable, composition = rocky_iron, atmosphere = metals_rich, eccentricity = elliptic, orbit_period_days = many, zone_class = warm, num_stars = 2, metallicity = medium, star_temp_class = m]).

% ----------------------------------------------------POST INCONTRO FACE TO FACE ALDO VS DANIELE CECCA - LO SCONTRO FINALE---------
%gj180c (meso TUTTI)
esempio(habitable, [radius = small, mass_class = superterran, density = medium, gravity = medium, eq_temp = acceptable, composition = rocky_iron, atmosphere = metals_rich, eccentricity = elliptic, orbit_period_days = a_lot, zone_class = warm, num_stars = 2, metallicity = low, star_temp_class = m]).

%gj422b
esempio(habitable, [radius = small, mass_class = superterran, density = medium, gravity = medium, eq_temp = acceptable, composition = rocky_iron, atmosphere = hydrogene_rich, eccentricity = elliptic, orbit_period_days = a_lot, zone_class = warm, num_stars = 1, metallicity = medium, star_temp_class = m]).

%gj667Cc
esempio(habitable, [radius = small, mass_class = terran, density = medium, gravity = medium, eq_temp = acceptable, composition = rocky_iron, atmosphere = metals_rich, eccentricity = elliptic, orbit_period_days = a_lot, zone_class = warm, num_stars = 6, metallicity = low, star_temp_class = m]).

%hd283869
esempio(habitable, [radius = small, mass_class = superterran, density = medium, gravity = medium, eq_temp = acceptable, composition = rocky_iron, atmosphere = metals_rich, eccentricity = circular, orbit_period_days = a_lot, zone_class = warm, num_stars = 1, metallicity = low, star_temp_class = k]).

%k272e
esempio(habitable, [radius = small, mass_class = terran, density = medium, gravity = weak, eq_temp = acceptable, composition = rocky_iron, atmosphere = metals_rich, eccentricity = circular, orbit_period_days = a_lot, zone_class = warm, num_stars = 4, metallicity = medium, star_temp_class = m]).

%kepler61b
esempio(habitable, [radius = small, mass_class = superterran, density = medium, gravity = medium, eq_temp = acceptable, composition = rocky_iron, atmosphere = hydrogene_rich, eccentricity = elliptic, orbit_period_days = a_lot, zone_class = warm, num_stars = 1, metallicity = low, star_temp_class = k]).

%kepler443
esempio(habitable, [radius = small, mass_class = superterran, density = medium, gravity = strong, eq_temp = acceptable, composition = rocky_iron, atmosphere = hydrogene_rich, eccentricity = elliptic, orbit_period_days = a_lot, zone_class = warm, num_stars = 1, metallicity = medium, star_temp_class = k]).

%wolf1071c
esempio(habitable, [radius = small, mass_class = terran, density = medium, gravity = medium, eq_temp = acceptable, composition = rocky_iron, atmosphere = metals_rich, eccentricity = elliptic, orbit_period_days = many, zone_class = warm, num_stars = 3, metallicity = low, star_temp_class = m]).
% ------------------------------------------------------------------------
%gj163c (psychroplanet TUTTI)
esempio(habitable, [radius = small, mass_class = superterran, density = medium, gravity = medium, eq_temp = acceptable, composition = rocky_iron, atmosphere = metals_rich, eccentricity = elliptic, orbit_period_days = a_lot, zone_class = warm, num_stars = 3, metallicity = low, star_temp_class = k]).

%gj367Ce
esempio(habitable, [radius = small, mass_class = terran, density = medium, gravity = weak, eq_temp = acceptable, composition = rocky_iron, atmosphere = metals_rich, eccentricity = elliptic, orbit_period_days = a_lot, zone_class = warm, num_stars = 6, metallicity = low, star_temp_class = m]).

%kapteynB
esempio(habitable, [radius = small, mass_class = terran, density = medium, gravity = medium, eq_temp = acceptable, composition = rocky_iron, atmosphere = metals_rich, eccentricity = elliptic, orbit_period_days = a_lot, zone_class = warm, num_stars = 2, metallicity = medium, star_temp_class = m]).

%trappist1e
esempio(habitable, [radius = small, mass_class = terran, density = medium, gravity = weak, eq_temp = acceptable, composition = rocky_iron, atmosphere = metals_rich, eccentricity = circular, orbit_period_days = few, zone_class = warm, num_stars = 7, metallicity = low, star_temp_class = m]).

%kepler1652b
esempio(habitable, [radius = small, mass_class = terran, density = medium, gravity = weak, eq_temp = acceptable, composition = rocky_iron, atmosphere = metals_rich, eccentricity = circular, orbit_period_days = a_lot, zone_class = warm, num_stars = 1, metallicity = low, star_temp_class = m]).

%kepler442b
esempio(habitable, [radius = small, mass_class = terran, density = medium, gravity = weak, eq_temp = acceptable, composition = rocky_iron, atmosphere = metals_rich, eccentricity = elliptic, orbit_period_days = a_lot, zone_class = warm, num_stars = 1, metallicity = medium, star_temp_class = k]).

%kepler1229b
esempio(habitable, [radius = small, mass_class = terran, density = medium, gravity = weak, eq_temp = acceptable, composition = rocky_iron, atmosphere = metals_rich, eccentricity = circular, orbit_period_days = a_lot, zone_class = warm, num_stars = 1, metallicity = low, star_temp_class = k]).

%proximaCenB
esempio(habitable, [radius = small, mass_class = terran, density = medium, gravity = weak, eq_temp = acceptable, composition = rocky_iron, atmosphere = metals_rich, eccentricity = circular, orbit_period_days = many, zone_class = warm, num_stars = 1, metallicity = medium, star_temp_class = m]).
% ------------------------------------------------------------------------
%gj86ab
esempio(non_habitable,[radius = medium, mass_class = jovian, density = medium, gravity = strong, eq_temp = too_high, composition = gas, atmosphere = hydrogene_rich, eccentricity = elliptic, orbit_period_days = many, zone_class = hot, num_stars = 1, metallicity = low, star_temp_class = g]).

%gj581b
esempio(non_habitable,[radius = small, mass_class = neptunian, density = low, gravity = weak, eq_temp = too_high, composition = gas, atmosphere = metals_rich, eccentricity = circular, orbit_period_days = few, zone_class = hot, num_stars = 3, metallicity = medium, star_temp_class = m]).

%hd38283b
esempio(non_habitable,[radius = medium, mass_class = jovian, density = low, gravity = medium, eq_temp = too_high, composition = gas, atmosphere = hydrogene_rich, eccentricity = elliptic, orbit_period_days = a_lot, zone_class = hot, num_stars = 1, metallicity = medium, star_temp_class = g]).

%k217b
esempio(non_habitable,[radius = small, mass_class = superterran, density = medium, gravity = strong, eq_temp = too_high, composition = rocky_iron, atmosphere = metals_rich, eccentricity = circular, orbit_period_days = many, zone_class = hot, num_stars = 1, metallicity = low, star_temp_class = k]).

%kepler68b
esempio(non_habitable,[radius = medium, mass_class = jovian, density = low, gravity = medium, eq_temp = too_high, composition = gas, atmosphere = hydrogene_rich, eccentricity = elliptic, orbit_period_days = a_lot, zone_class = warm, num_stars = 3, metallicity = medium, star_temp_class = g]).

%wasp80b
esempio(non_habitable,[radius = medium, mass_class = jovian, density = low, gravity = medium, eq_temp = too_high, composition = gas, atmosphere = hydrogene_rich, eccentricity = elliptic, orbit_period_days = few, zone_class = hot, num_stars = 1, metallicity = medium, star_temp_class = k]).
