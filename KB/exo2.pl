...
prop(gj_180_c, hostname, gj_180).
prop(gj_422_b, hostname, gj_422).
prop(gj_667_Cc, hostname, gj_667).
prop(hd_283869_b, hostname, hd_28369).
prop(kepler_61_b, hostname, kepler_61).
prop(kepler_443_b, hostname, kepler_443).
...
prop(gj_180_c,was_discovered_in,2014).
prop(gj_422_b,was_discovered_in, 2014).
prop(gj_667_Cc, was_discovered_in, 2011).
...
prop(gj_180_c, has_radius, 2.17).
prop(gj_422_b,has_radius, 2.38).
prop(gj_667_Cc, has_radius, 1.54).
prop(hd_283869_b, has_radius, 2.36).
prop(kepler_61_b, has_radius, 2.15).
prop(kepler_443_b, has_radius, 2.33).
...
prop(gj_180_c, has_density, 1.16).
prop(gj_422_b, has_density, 1.28).
prop(gj_667_Cc, has_density, 1.05).
...
prop(gj_180_c,has_gravity , 2.04).
prop(gj_422_b,has_gravity , 2.53).
prop(gj_667_Cc, has_gravity, 2.01).
...
prop(gj_180_c, has_temp, 239.5).
prop(gj_422_b, has_temp, 231.3).
prop(gj_667_Cc, has_temp, 246.5).
...
prop(gj_180_c, has_composition, rocky_iron).
prop(gj_422_b, has_composition, rocky_iron).
prop(gj_667_Cc, has_composition, rocky_iron).
...
prop(gj_180_c, has_atmosphere, metals_rich).
prop(gj_422_b, has_atmosphere, hydrogene_rich).
prop(gj_667_Cc, has_atmosphere, metals_rich).
...
prop(gj_180_c,has_eccentricity, 0.09).
prop(gj_422_b,has_eccentricity, 0.05).
prop(gj_667_Cc, has_eccentricity, 0.02).
...
prop(gj_180_c,has_orbit_period, 24.33).
prop(gj_422_b,has_orbit_period, 26.16).
prop(gj_667_Cc, has_orbit_period, 28.14).
...
%habitabilityzonedistance(from his star)
...
prop(gj_180_c, distance_from_star, -0.53).
prop(gj_422_b, distance_from_star, -0.41).
prop(gj_667_Cc, distance_from_star, -1.02).
...
prop(kapteyn_b, distance_from_star, 0.12).
...
prop(gj_180_c, his_star_has_met, -0.06).
prop(gj_422_b, his_star_has_met, -0.2).
prop(gj_667_Cc, his_star_has_met, 0.2).
...
prop(gj_180_c, his_star_has_temp, 3371).
prop(gj_422_b, his_star_has_temp, 3323).
prop(gj_667_Cc, his_star_has_temp, 3350).
...
%Habitability
prop(k2_139_b, is_hab_class, non_habitable).
prop(k2_10_b, is_hab_class, non_habitable).
prop(k2_110_b, is_hab_class, non_habitable).
prop(k2_18_b, is_hab_class, habitable).
prop(k2_72_e, is_hab_class, habitable).
prop(wasp_118_b, is_hab_class, non_habitable).
prop(wasp_75_b, is_hab_class,  non_habitable).
prop(wolf_503_b, is_hab_class, non_habitable).
prop(trappist_1_b, is_hab_class, non_habitable).
prop(trappist_1_c, is_hab_class, non_habitable).
prop(trappist_1_f, is_hab_class, habitable).
prop(trappist_1_g, is_hab_class, habitable).
prop(hd_3167_d, is_hab_class, non_habitable).
prop(ross_128_b, is_hab_class, habitable).
prop(gj_9827_b, is_hab_class, non_habitable).
prop(gj_180_c, is_hab_class, habitable).
prop(gj_422_b, is_hab_class, habitable).
prop(gj_667_Cc, is_hab_class, habitable).
prop(gj_9827_b, is_hab_class, non_habitable).
prop(gj_180_c, is_hab_class, habitable).
prop(gj_422_b, is_hab_class, habitable).
prop(gj_667_Cc, is_hab_class, habitable).
prop(hd_283869_b, is_hab_class, habitable).
prop(kepler_61_b, is_hab_class, habitable).
prop(kepler_443_b, is_hab_class, habitable).
prop(wolf_1061_c, is_hab_class, habitable).
prop(gj_163_c, is_hab_class, habitable).
prop(gj_3634_b, is_hab_class, non_habitable).
prop(kapteyn_b, is_hab_class, habitable).
prop(trappist_1_e, is_hab_class, habitable).
prop(kepler_1652_b, is_hab_class, habitable).
prop(kepler_442_b, is_hab_class, habitable).
prop(kepler_1229_b, is_hab_class, habitable).
prop(proxima_cen_b, is_hab_class, habitable).
prop(gj_86_ab, is_hab_class, non_habitable).
prop(gj_581_b, is_hab_class, non_habitable).
prop(k2_17_b, is_hab_class, non_habitable).
prop(hd_38283_b, is_hab_class, non_habitable).
prop(kepler_68_b, is_hab_class, non_habitable).
prop(wasp_80_b, is_hab_class, non_habitable).
...
% esempio(habitable, [massRadius_class = terran, density = medium,
% gravity = weak, eq_temp = acceptable, composition = rocky_iron,
% atmosphere = metals_rich, eccentricity = circular, orbit_period_days =
% a_lot, zone_class = warm, num_stars = 1, metallicity = low,
% star_temp_class = m]).
% esempio(non_habitable, [massRadius_class = jovian, density = low,
% gravity = medium, eq_temp = too_high, composition = gas, atmosphere =
% hydrogene_rich, eccentricity = elliptic, orbit_period_days = a_lot,
% zone_class = hot, num_stars = 1, metallicity = medium, star_temp_class
% = g]).
