...
%k2_18_b (mesoplanet)
esempio(habitable, [massRadius_class = neptunian, density = medium, gravity = high, eq_temp = acceptable, composition = rocky_iron, atmosphere = hydrogene_rich, eccentricity = elliptic, orbit_period_days = a_lot, zone_class = warm, num_stars = 1, metallicity = medium, star_temp_class = m]).

%k2_10_b
esempio(non_habitable, [massRadius_class = neptunian, density = low, gravity = medium, eq_temp = too_high, composition = water_gas, atmosphere = metals_rich, eccentricity = elliptic, orbit_period_days = many, zone_class = hot, num_stars = 1, metallicity = low, star_temp_class = g]).

%trappist_1f (psyc)
esempio(habitable, [massRadius_class = terran, density = low, gravity = weak, eq_temp = acceptable, composition = rocky_water, atmosphere = metals_rich, eccentricity = parabolic, orbit_period_days = few, zone_class = warm, num_stars = 1, metallicity = medium, star_temp_class = m]).

%trappist_1b
esempio(non_habitable, [massRadius_class = terran, density = medium, gravity = weak, eq_temp = too_high, composition = rocky_water, atmosphere = metals_rich, eccentricity = circular, orbit_period_days = few, zone_class = hot, num_stars = 1, metallicity = medium, star_temp_class = m]).

%k2_139_b
esempio(non_habitable,[massRadius_class = jovian, density = low, gravity = weak, eq_temp = too_high, composition = gas, atmosphere = hydrogene_rich, eccentricity = elliptic, orbit_period_days = a_lot, zone_class = hot, num_stars = 1, metallicity = medium, star_temp_class = g]).

%k2_110_b
esempio(non_habitable,[massRadius_class = neptunian, density = medium, gravity = medium, eq_temp = too_high, composition = rocky_water, atmosphere = metals_rich, eccentricity = circular, orbit_period_days = many, zone_class = hot, num_stars = 1, metallicity = low, star_temp_class = k]).

%wasp_118_b
esempio(non_habitable,[massRadius_class = jovian, density = medium, gravity = weak, eq_temp = too_much_high, composition = gas, atmosphere = metals_rich, eccentricity = circular, orbit_period_days = few, zone_class = hot, num_stars = 1, metallicity = medium, star_temp_class = f]).

%ross_128_b (meso)
esempio(habitable, [massRadius_class = terran, density = medium, gravity = weak, eq_temp = acceptable, composition = rocky_iron, atmosphere = metals_rich, eccentricity = parabolic, orbit_period_days = many, zone_class = warm, num_stars = 1, metallicity = low, star_temp_class = m]).

%gj180b (meso)
esempio(habitable, [massRadius_class = superterran, density = medium, gravity = medium, eq_temp = acceptable, composition = rocky_iron, atmosphere = metals_rich, eccentricity = elliptic, orbit_period_days = many, zone_class = warm, num_stars = 2, metallicity = medium, star_temp_class = m]).
